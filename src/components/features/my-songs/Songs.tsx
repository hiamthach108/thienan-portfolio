...
const Songs = () => {
  return (
    <div>
      <div className="py-6">
        <h3 className="section-heading text-center">Bay</h3>
        <div className="my-4 flex flex-col gap-2 text-left">
          <p>
            ...
            soaring, for the desire to break through all limits to reach a boundless sky—a
            journey of growth that I envision as a young bird taking flight for the first
            time.
          </p>
          <p>
            🌿 One day, that small bird will have to grow up, and face challenges on its
            own, getting out of the company of its parents. The song reflects not only my
            yearning to fly far and wide but also my profound gratitude and respect for my
            beloved parents, my rock, and my dearest friends.
          </p>
      ...
      <div className="py-6">
        <h3 className="section-heading text-center">Embrace</h3>
        <div className="my-4 flex flex-col gap-2 text-left">
          <p>
            ✨ Then, I suddenly realized that youth is fleeting. In the blink of an eye,
            all the memories—both joyful and sorrowful—faded, slipping away with the
            passage of time. At that moment, I asked myself: Have I truly given my all to
            life? Have I lived fully in pursuit of my dreams?
          </p>
          <p>
            &quot;I want to embrace the moment yet to come I want to embrace the joy that
            never fades And listening to the pounding, echoing heart We weave a tale that
            will forever unfold.&quot;
          </p>
          <p>
